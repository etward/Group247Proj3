...
img = cv2.imread("Images/portrait.png") #this is variable to do the face detection
img2 = Image.open("Images/portrait.png") #this is the variable to do the cropping
...
def question2(songChoice):
    choice2 = raw_input("Please choose a song between 1 - 8:  ")
    songChoice = choice2
    if not choice2 in possiblesongs:
        print "Sorry! Please enter a number between 1 - 8 "
        print " "
...
if songChoice == "1":
    songLink = MIMEText(" https://sites.google.com/a/csumb.edu/funfaceswap/home/pictures-and-audio/Funny%20Breathe.mp3?attredirects=0&d=1")

if songChoice == "2":
    songLink = MIMEText(" https://sites.google.com/a/csumb.edu/funfaceswap/home/pictures-and-audio/Buff%20Guy.mp3?attredirects=0&d=1")
    
if songChoice == "3":
    songLink = MIMEText(" https://sites.google.com/a/csumb.edu/funfaceswap/home/pictures-and-audio/Sexy%20Time.mp3?attredirects=0&d=1")

if songChoice == "4":
    songLink = MIMEText(" https://sites.google.com/a/csumb.edu/funfaceswap/home/pictures-and-audio/Hispanic%20Flare.mp3?attredirects=0&d=1")
    
if songChoice == "5":
    songLink = MIMEText(" https://sites.google.com/a/csumb.edu/funfaceswap/home/pictures-and-audio/Man%20Sandwich%20%202.mp3?attredirects=0&d=1")

if songChoice == "6":
    songLink = MIMEText(" https://sites.google.com/a/csumb.edu/funfaceswap/home/pictures-and-audio/Man%20Sandwich.mp3?attredirects=0&d=1")

if songChoice == "7":
    songLink = MIMEText(" https://sites.google.com/a/csumb.edu/funfaceswap/home/pictures-and-audio/Sexy%20Time.mp3?attredirects=0&d=1")
    
if songChoice == "8":
    songLink = MIMEText(" https://sites.google.com/a/csumb.edu/funfaceswap/home/pictures-and-audio/Toilet.mp3?attredirects=0&d=1")
